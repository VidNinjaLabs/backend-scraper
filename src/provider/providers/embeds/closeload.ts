...
function decodeCloseload(valueParts: string[]): string {
  ...
  // Step 3: ROT13-like transformation
...
export const closeLoadScraper = makeEmbed({
  ...
  async scrape(ctx) {
    ...
    // Try to find m3u8 URL directly in the decoded script
    ...
    // Try to find mp4 URL directly in the decoded script
