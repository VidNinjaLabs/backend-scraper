 ...
 * @returns Codename
 */
export declare function anonymizeSourceId(providerId: string): string;
 ...
 */
export declare function fetchSubtitles(options: SubtitleOptions): Promise<Subtitle[]>;
 ...
 */
export declare function getProviderCodename(providerId: string): string;
 ...
 */
export declare function getProviderIdFromCodename(codename: string): string | null;
...
export declare function makeProxiedFetcher(_f: FetchLike): Fetcher;

export declare function makeSimpleProxyFetcher(proxyUrl: string, f: FetchLike): Fetcher;

export declare function makeStandardFetcher(_f: FetchLike): Fetcher;
...
export declare interface ProviderControls {
    ...
    runAllFast(runnerOps: RunnerOptions): Promise<RunOutput | null>;
 ...
 */
export declare function resolveSourceId(input: string | undefined, sources: any[]): string | null;
